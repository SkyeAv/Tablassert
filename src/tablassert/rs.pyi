...
def extract_prebuilt_fullmap(
    archive: Path, output: Path, progress: Callable[[str], None] | None = None, taxon_allowlist: list[int] | None = None
) -> None: ...
def fullmap_source_version() -> str: ...
def fullmap_taxon_allowlist_identity(db: Path) -> str | None: ...
...
def taxon_allowlist_identity(taxon_allowlist: list[int]) -> str: ...
