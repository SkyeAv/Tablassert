...
used. The choice is resolved once per run, after the reuse short-circuit, and logged either way; a
failing aria2c download fails loud rather than being silently rescued by the Python downloader.
